...
- Suite Android finale: `:app:build`, test JVM/Robolectric, APK debug e release, lint. Risultato finale registrato nella release e nel rapporto di build allegato. Nessun test rimosso, nessun controllo lint disabilitato. La variante consegnata è debug; l'APK release non firmato non viene presentato come installabile.
