...
@Serializable data class AppEvent(val id: String,val sender_id: String,val sender_name: String,val kind: String,
    val created_at: String,val expires_at: String,val payload: JsonObject,
    @Serializable(with=EventRecipientsSerializer::class) val recipients: List<String> = emptyList()) {
