...
@AndroidEntryPoint class LocationForegroundService: Service() {
    ...
    override fun onCreate() {
        super.onCreate()
        getSystemService(NotificationManager::class.java).createNotificationChannel(NotificationChannel("sharing",getString(R.string.sharing_channel),NotificationManager.IMPORTANCE_LOW))
    }
    override fun onStartCommand(intent: Intent?,flags: Int,startId: Int): Int {
        ...
        val notification=NotificationCompat.Builder(this,"sharing").setSmallIcon(R.drawable.ic_location)
            .setContentTitle(getString(R.string.sharing_active)).setContentText(getString(R.string.minute_update))
