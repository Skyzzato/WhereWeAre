...
try {
 ...
 for(const file of ['sos.sql','nearby_sos.sql','nearby_limits.sql','places_rules.sql','checkins.sql','temporary_groups.sql','shared_precision.sql','location_requests.sql']) {
 ...
 console.log('v0.42 SQL TESTS PASSED');
