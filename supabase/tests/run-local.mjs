...
try {
 for(const file of ['supabase/tests/local_bootstrap.sql','supabase/migrations/001_initial_schema.sql','supabase/tests/security.sql','supabase/migrations/002_v0_2.sql','supabase/tests/security_v02.sql']) {
